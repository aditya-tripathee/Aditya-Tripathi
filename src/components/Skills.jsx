...
const frontend = ["HTML5","CSS3","Tailwind CSS","Prebuilt UI","Framer Motion","ShadCN","React.js","Next.js","Redux Toolkit","Zustand"];
      ...
      {skills.map((skill, idx) => (
        <span
          key={idx}
                ...
                className="px-3 py-1 text-xs rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 text-white font-medium shadow-lg
